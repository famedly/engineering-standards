...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  passthru = {
    # `vod.init(libraryPath: ...)` wants the directory, not the file.
    libraryPath = "${finalAttrs.finalPackage}/lib";
    libraryName = "libvodozemac_bindings_dart${stdenv.hostPlatform.extensions.sharedLibrary}";
  };
